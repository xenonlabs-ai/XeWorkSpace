			...
			<div className="container flex flex-col items-center justify-between gap-4 py-6 md:h-20 md:flex-row md:py-0 max-w-full">
				<div className="flex flex-col items-center gap-4 px-8 md:flex-row md:gap-2 md:px-0">
					<p className="text-center text-sm text-muted-foreground md:text-left">
						&copy; {new Date().getFullYear()} XeWorkspace. All rights reserved.
					</p>
				</div>
				<div className="flex items-center gap-4">
					...
					<Link href="mailto:support@XeWorkspace.com" className="text-muted-foreground hover:text-foreground">
